...
public class Permission_PermissionsBukkit extends Permission {
    ...
    public boolean groupHas(String world, String group, String permission) {
        if (world != null && !world.isEmpty()) {
            return perms.getGroup(group).getInfo().getWorldPermissions(world).get(permission) != null && perms.getGroup(group).getInfo().getWorldPermissions(world).get(permission);
        }
