    ...
    public class PermissionServerListener
            ...
            if (permission.overPerms == null) {
                ...
                if (perms != null) {
                    ...
                    Permission_OverPermissions.log.info(String
                            .format("[%s][Permission] %s hooked.", Permission_OverPermissions.this.plugin.getDescription().getName(), "OverPermissions"));
                }
            }
        }
        ...
        public void onPluginDisable(PluginDisableEvent event) {
            if ((permission.overPerms != null) &&
                ...
                Permission_OverPermissions.log.info(String
                        .format("[%s][Permission] %s un-hooked.", Permission_OverPermissions.this.plugin.getDescription().getName(), "OverPermissions"));
            }
        }
    }
}
